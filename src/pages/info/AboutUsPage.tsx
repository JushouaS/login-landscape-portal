    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-indigo-50">
      <div className="container mx-auto px-4 py-16 space-y-12">
        ...
        <div className="text-center space-y-4 animate-fade-in">
          <h1 className="text-4xl font-bold text-blue-800">Our Story</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            SellMate was founded with a simple yet powerful vision: to create a platform that makes 
        ...
        <Card className="border-blue-200 bg-white/50 backdrop-blur-sm animate-fade-in">
          <CardHeader>
            <CardTitle className="text-center text-2xl italic text-blue-600">
        ...
        <div className="prose max-w-none space-y-6 animate-fade-in">
          <h2 className="text-3xl font-semibold text-blue-800">How SellMate Works</h2>
          <p className="text-gray-600">
            SellMate is more than just a marketplace - it's a comprehensive ecosystem designed 
