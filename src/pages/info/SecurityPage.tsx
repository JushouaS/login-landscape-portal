          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-xl shadow-lg">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                  <h2 className="text-2xl font-semibold mb-2">Have security concerns?</h2>
                  <p className="opacity-90">Our security team is available 24/7 to address any issues.</p>
                </div>
                <button 
                  className="bg-white text-blue-600 font-medium py-2 px-6 rounded-lg hover:bg-blue-50 transition-colors"
                  onClick={() => window.location.href = 'mailto:security@sellmate.com'}
                >
